...
# https://www.cdc.gov/nchs/images/icd/icd_9_and_10_differences.png 

#' convert_icd9dx_TO_ccc
#' 
#' ICD9 CM (diagnoses) -> Complex Chronic Conditions (ED and PDD data)
#' Implied decimal after the first digit
#' 
#' @example 
#' data_ = data_ %>% mutate(
...
convert_icd9dx_TO_ccc = function(column){
  temp = column

  ccc_label = case_when(
    temp %in% c(
      "3180","3181","3182","330","33111","33119","3314","33189","3319","3320",
      "3321","3330","3332","3334","3335","3337","3339","334","335","343",
      "34501","34581","3590","3591","3592","3593","3361","3368","3379","3418",
      "34290","343","3440","34481","3449","34511","3453","34541","34561",
      "34571","34591","3481","3484","3491","43401","43491","359","740",
      "741","742","7595","78003","9962","99663","V452","V5301","V5302") ~ "Neurologic and Neuromuscular",
    
    temp %in% c(
      "4161","4al168","4169","4240","4258","4242","4243","4250","4251","4252",
      "4253","4254","426","4270","4271","4272","4273","4274","4276","4277",
      "4278","4279","4280","42883","4291","4293","43311","7450","7451","7452",
      "7453","7456","746","7471","7472","7473","7474","74781","74789","9960",
      "9961","99661","99662","V421","V422","V432","V433","V450","V4581",
      "V533") ~ "Cardiovascular",
    
    temp %in% c(
      "32725","4162","5163","51631","51884","5190","2770","748","7704","V426",
      "V440","V4576","V460","V461","V550") ~ "Respiratory",
    
    temp %in% c(
      "34461","585","5964","59653","59654","753","99668","V420","V445","V446",
      "V451","V4573","V4574","V536","V555","V556","V56") ~ "Renal and urologic",
    
    temp %in% c(
      "4530","5364","555","556","5571","5602","5647","5714","5715","5716",
      "5717","5718","5719","7503","751","V427","V4283","V4284","V441","V442",
      "V443","V444","V5350","V5351","V5359","V551","V552","V553","V554") ~ "Gastrointestinal",
    
    temp %in% c(
      "042","043","044","135","279","2820","2821","2822","2823","2824","2825",
      "2826","2881","2882","284","2860","2863","28732","28733","28739","28801",
      "28802","2884","4460","4461","44621","4464","4465","4466","4467","7100",
      "7101","7103","V08") ~ "Hematologic or immunologic",
    
    temp %in% c(
      "243","2532","2535","2536","2359","2550","25513","2552","270","271","272",
      "2750","2751","2752","2753","2772","2773","2774","2775","2776","2778",
      "2779","V4585","V5391","V6546") ~ "Metabolic",
    
    temp %in% c(
      "2594","5533","7373","7560","7561","7562","7563","7564","7565","7566",
      "7567","758","7597","7598","7599") ~ "Other congenital or Genetic defect",
    
    temp %in% c(
      "14","15","16","17","18","19","20","23","V4281","V4282") 
    ~ "Malignancy",
    
    temp %in% c(
      "76401","76402","76411","76412","76421","76422","76491","76492","76501",
      "76502","76511","76512","76521","76522","76523","7670","7674","7685",
      "7687","7689","7702","7707","7710","7711","77213","77214","7733","7734",
      "7747","7765","77753","7780","7797") ~ "Premature and neonatal",
    
    temp %in% c(
      "5190","5364","9960","9961","9962","9964","99661","99662","99663","99666",
      "99667","99668","9969","V433","V440","V441","V442","V443","V444","V445",
      "V446","V450","V451","V452","V460","V461","V462","V5301","V5302","V5331",
      "V5332","V5339","V5350","V5351","V5359","V536","V550","V551","V552",
      "V553","V554","V555","V556") ~ "Technology dependence",
    
    temp %in% c(
      "99680","99681","99682","99683","99684","99685","99686","99687","99688",
      "99689","V421","V422","V426","V427","V4281","V4282","V4283","V4284",
      "V432","V4585","V5391") ~ "Transplantation"
    )
    return(ccc_label)
  }
  
  #' ICD9-CM (procedures) -> Complex Chronic Conditions (PDD/Inpatient Data)
  #' 
  #' Implied decimal after the 2nd digit
  convert_icd9pr_TO_ccc = function(column){
    temp = column
    
    ccc_label = case_when(
    temp %in% c(
      "0152","0153","0221","0222","0231","0232","0233","0234","0235","0239",
      "0241","0242","0293","0371","0372","0379","0393","0397","0492") ~ "Neurologic and Neuromuscular",
    
    temp %in% c(
      "0050","0051","0053","0054","0055","0057","1751","1752","3581","3582",
      "3583","3584","3741","3751","3752","3753","3754","3755","3760","3761",
      "3763","3765","3766","3767","3768","3771","3772","3774","3776","3779",
      "3780","3781","3782","3783","3785","3786","3787","3789","3794","3795",
      "3796","3797","3798","3981","3982","3983","3984","3985","8945","8946",
      "8947","8948","8949") ~ "Cardiovascular",
    
    temp %in% c(
      "303","304","3121","3129","3141","3174","3241","3249","3250","3259",
      "3321","3350","3351","3352","336", "3485","9655","9723") ~ "Respiratory",
    
    temp %in% c(
      "3895","3927","3942","3993","3994","3995","5498","5502","5503","5504",
      "5512","5551","5552","5553","5554","5561","5569","5593","5594","5597",
      "5641","5642","5651","5652","5661","5662","5671","5672","5673","5674",
      "5675","5679","5721","5722","5771","5779","5993","5994","8607","9645",
      "9646","9647") ~ "Renal and urologic",
    
    temp %in% c(
      "253","254","4210","4211","4242","4281","4311","4319","4391","4399",
      "4412","4432","4438","4439","4563","4581","4582","4583","4613","4622",
      "4623","4632","4640","4641","4643","4697","504", "5051","5059","526",
      "527","5280","5282","5283","5284","5285","5286","5471","9624","9636",
      "9702") ~ "Gastrointestinal",
    
    temp %in% c(
      "4100","4101","4102","4103","4104","4105","4106","4107","4108","4109",
      "415", "4194") ~ "Hematologic or immunologic",
    
    temp %in% c(
      "064","0652","0681","073","0764","0765","0768","0769","624","6241","645",
      "6551","6553","6561","6563","6841","6849","6851","6859","6861","6869",
      "6871","6879","8606") ~ "Metabolic",
    
    temp %in% c("0010","9925") ~ "Malignancy",
    
    temp %in% c(
      "0221","0222","0231","0232","0233","0234","0235","0239","0241","0242",
      "0293","0371","0372","0379","0393","0397","0492","0050","0051","0053",
      "0054","0055","0057","1751","1752","3741","3752","3753","3754","3755",
      "3760","3761","3763","3765","3766","3767","3768","3771","3772","3774",
      "3776","3779","3780","3781","3782","3783","3785","3786","3787","3789",
      "3794","3795","3796","3797","3798","3981","3982","3983","3984","3985",
      "8945","8946","8947","8948","8949","3121","3129","3141","3174","3321",
      "3485","9655","9723","3895","3927","3942","3993","3994","3995","5498",
      "5502","5503","5504","5512","5593","5594","5597","5651","5652","5661",
      "5662","5672","5673","5674","5675","5721","5722","5993","5994","8607",
      "9645","9646","9647","4210","4211","4281","4311","4319","4412","4432",
      "4438","4439","4613","4622","4623","4632","4640","4641","4643","9624",
      "9636","9702","8100","8101","8102","8103","8104","8105","8106","8107",
      "8108","8109","8130","8131","8132","8133","8134","8135","8136","8137",
      "8138","8139","8451") ~ "Technology dependence",
    
    temp %in% c(
      "3751","3350","3351","3352","336", "5561","5569","4697","5051","5059",
      "5280","5282","5283","5284","5285","5286","4100","4101","4102","4103",
      "4104","4105","4106","4107","4108","4109","4194","0091","0092","0093") ~ "Transplantation"
  )
  return(ccc_label)
}
  
#' ICD10-CM (diagnoses) -> Complex Chronic Conditions 
convert_icd10cm_TO_ccc = function(column){
    temp = column
    
  ccc_label = case_when(
    temp %in% c(
      "E750","E751","E752","E754","F71","F72","F73","F842","G111","G112","G114",
      "G118","G119","G120","G121","G122","G128","G129","G3101","G3109","G318",
      "G3189","G3289","G71","G72","G80","G901","G938","G939","G94","Q00","Q01",
      "Q02","Q03","Q04","Q05","Q06","Q07","G911","G319","G253","G9519","G9589",
      "G909","G40311","G40301","G40211","G40219","G40411","G40419","G40804",
      "G40111","G40119","G40911","G40919","G371","G372","G378","G8190","G8290",
      "G8250","G8251","G8252","G8253","G8254","G835","G839","G931","G935",
      "I6330","I6350","G10","G20","G210","G2111","G2119","G218","G230","G231",
      "G232","G238","G2402","G248","G253","G254","G255","G2581","G2582","G2583",
      "G2589","G259","G803","R403","G9782","T8509XA","T85190A","T85192A",
      "T85199A","T8579XA","Z982","Z4541","Z4542") ~ "Neurologic and Neuromuscular",
    
    temp %in% c(
      "I270","I271","I272","I2781","I2789","I279","I340","I348","I360","I368","
      I370","I378","I42","I43","I44","I45","I47","I48","I490","I491","I493",
      "I494","I495","I498","I499", "I509","I515","I517","I5181","I63139",
      "I63239","Q20","Q212","Q213","Q214","Q218","Q22","Q23","Q24","Q251",
      "Q252","Q253","Q254","Q255","Q256","Q257","Q26","R001","Q282","Q283",
      "Q289","Z951","T82519A","T82529A","T82539A","T82599A","T82110A","T82111A",
      "T82120A","T82121A","T82190A","T82191A","T8201XA","T8202XA","T8203XA",
      "T8209XA","T82211A","T82212A","T82213A","T82218A","T82221A","T82222A",
      "T82223A","T82228A","T82518A","T82528A","T82538A","T82598A","T826XXA",
      "T827XXA","Z941","Z950","Z952","Z95810","Z95811","Z95812","Z95818","Z953",
      "Z45010","Z45018","Z4502","Z4509","Z959") ~ "Cardiovascular",
    
    temp %in% c(
      "E84","G4753","I2782","I43","Q30","Q31","Q32","Q33","Q34","P280","Z902",
      "J84112","J9500","J9501","J9502","J9503","J9504","J9509","9620","Z430",
      "Z930","Z942","Z990","J95850","Z9911","Z9912","T86810","T86811","T86819") ~ "Respiratory",
    
    temp %in% c(
      "N18","Q60","Q61","Q62","Q63","Q64","Z905","Z906","G834","N312","N319",
      "T8571XA","Z940","Z9350","Z9351","Z9352","Z9359","Z936","Z9115","Z992",
      "Z435","Z436","Z446","Z4901","Z4902","Z4931","Z4932","T8610","T8611","T8612") ~ "Renal and urologic",
    
    temp %in% c(
      "K50","K51","K73","K74","K754","K760","K761","K762","K763","K768","Q390",
      "Q391","Q392","Q393","Q394","Q41","Q42","Q43","Q44","Q45","I820","K551",
      "K562","K593","Z980","Z903","Z9049","K9420","K9422","K9423","K9429","Z944",
      "Z9482","Z9483","Z931","Z932","Z933","Z934","Z431","Z432","Z433","Z434",
      "Z4651","Z4659","T8640","T8641","T8642","T86890","T86891","T86899",
      "T86850","T86851","T86859") ~ "Gastrointestinal",
    
    temp %in% c(
      "B20", "D55","D56","D57","D58","D60","D61","D71","D720","D80","D81","D82", 
      "D83","D84","D85","D87","D88","D86","M303","M359","B21","B22","B23","B24",
      "D700","D704","D66", "D682","D6941","D6942","D761","D762","D763","D869",
      "M300","M310","M311","M3130","M314","M316","M3210","M3390","M340","M341",
      "M349","Z21") ~ "Hematologic or immunologic",
    
    temp %in% c(
      "D841","E700","E702","E703","E704","E705","E708","E710","E711","E712",
      "E713", "E714","E715","E720","E721","E722","E723","E724","E728","E729",
      "E740","E741","E742","E743","E744","E748","E749","E75","E760","E761",
      "E762","E763","E770","E771","E780","E781","E782","E783","E784","E785",
      "E786","E787","E788","E789","E791","E798","E804","E805","E806","E807",
      "E830","E831","E833","E834","E88","H498","E85","E009","E230","E232",
      "E222","E233","E237","E240","E242","E243","E248","E249","E2681","E250",
      "E258","E259","Z4681","Z794","Z9641") ~ "Metabolic",
    
    temp %in% c(
      "E343","K449","M410","M412","M4130","M418","M419","M4330","M965","Q722",
      "Q750","Q752","Q759","Q760","Q761","Q762","Q764","Q765","Q766","Q767",
      "Q77","Q780","Q781","Q782","Q783","Q784","Q788","Q789","Q790","Q791",
      "Q792","Q793","Q794","Q799","Q795","Q8740","Q8781","Q8789","Q897","Q899",
      "Q909","Q913","Q914","Q917","Q928","Q93","Q950","Q969","Q97","Q98",
      "Q992","Q998","Q999","Q898","Q81") ~ "Other congenital or Genetic defect",
    
    temp %in% c(
      "C","D00","D01","D02","D03","D04","D05","D06","D07","D08","D09","D37",
      "D38","D39","D3A0","D40","D41","D42","D43","D44","D45","D46","D47","D48",
      "D49","Q850","Z9481","Z9484","T8600","T8601","T8602","T8609") ~ "Malignancy",
    
    temp %in% c(
      "P0501","P0511","P0502","P0512","P052","P059","P0701","P0702","P0721",
      "P0722","P0723","P0724","P0725","P100","P101","P104","P524","P528","P115",
      "P84","P916","P210","P250","P251","P253","P258","P219","P270","P271",
      "P278","P350","P351","P2521","P2522","P560","P570","P578","P613","P614",
      "P773","P832","P912") ~ "Premature and neonatal",
    
    temp %in% c(
      "T8509XA","T85190A","T85192A","T85199A","T8579XA","Z982","Z45441",
      "Z45442","T82519A","T82529A","T82539A","T82599A","T82110A","T82111A",
      "T82120A","T82121A","T82190A","T82191A","T8201XA","T8202XA","T8203XA",
      "T8209XA","T82211A","T82212A","T82213A","T82218A","T82221A","T82222A",
      "T82223A","T82228A","T82518A","T82528A","T82538A","T82598A","T826XXA",
      "T827XXA","Z950","Z952","Z953","Z95810","Z95811","Z95812","Z95818",
      "Z45010","Z45018","Z4502","Z4509","Z959","J9500","J9501","J9502","J9503",
      "J9504","J9509","Z430","Z930","Z942","Z990","J95850","Z9911","Z9912",
      "T8571XA",'Z940',"Z9350","Z9351","Z9352","Z9359","Z936","Z9115","Z992",
      "Z435","Z436","Z446","K9420","K9422","K9423","K9429","Z931","Z932","Z933",
      "Z934","Z431","Z432","Z433","Z434","Z4651","Z4659","Z4681","Z9641",
      "T84019A","T84029A","T84039A","T84049A","T84059A","T84069A","T84099A",
      "T84498A","T84119A","T84129A","T84199A","T84498A","T8450XA","T8460XA",
      "T847XXA","T8690","T8691","T8692","T8699","T8610","T8611","T8612","T8640",
      "T8641","T8642","T8620","T8621","T8622","T86810","T86811","T86819",
      "T8600","T8601","T8602","T8609","T86890","T86891","T86899","T86850",
      "T86851","T86859","T865","T86890","T86891","T86899","T870X9","T871X9",
      "T872","Y831","Y833") ~ "Technology dependence",
    
    temp %in% c(
      "T8600","T8601","T8602","T8609","T8610","T8611","T8612","T8620","T8621",
      "T8622","T86810","T86811","T86819","T8640","T8641","T8642","T86890",
      "T86891","T86899","T86850","T86851","T86859","T865","T8690","T8691",
      "T8692","T8699","T86890","T86891","T86899") ~ "Transplantation"
  )
  return(ccc_label)
}
#' ICD10-CM(procedures) -> Complex Chronic Conditions
#' 
convert_icd10pcs_TO_ccc = function(column){
  temp = column
  ...
  ccc_label = case_when(
    temp %in% c(
      ...
      "0DH64MZ","0W110J9","0W110JB","0W110JG","0W110JJ","3E1Q38X","3E1Q38Z") ~ "Neurologic and Neuromuscular",
    ...
    temp %in% c(
      ...
      "4B02XSZ","4B02XTZ","5A02110","5A02116","5A0211D","5A02210","5A02216","5A0221D") ~ "Cardiovascular",
    ...
    temp %in% c(
      ...
      "0CTS8ZZ","0JH604Z","0JH634Z","0JH804Z","0JH834Z","0WQ6XZ2","3E1F78Z") ~ "Respiratory",
    ...
    temp %in% c(
      ...
      "0TY00Z1","0TY00Z2","0TY10Z0","0TY10Z1","0TY10Z2","3E1K38Z","3E1M39Z","5A1D60Z") ~ "Renal and urologic",
    ...
    temp %in% c(
      ...
      "3E0J7U1","3E0J8U0","3E0J8U1","3E1G78Z","3E1H78Z") ~ "Gastrointestinal",
    ...
    temp %in% c(
      ...
      "30263X0","30263X1","30263Y0","30263Y1") ~ "Hematologic or immunologic",
    ...
    temp %in% c(
      ...
      "0W4M070","0W4M0J0","0W4M0K0","0W4M0Z0","0W4N071","0W4N0J1","0W4N0K1","0W4N0Z1") ~ "Metabolic",
    ...
    temp %in% c(
      ...
      "0SG04KJ","0SG04Z0","0SG04Z1","0SG04ZJ") ~ "Technology dependence",
    ...
    temp %in% c(
      ...
      "30263G0","30263G1","30263X0","30263X1","30263Y0","30263Y1") ~ "Transplantation"
  )
  return(ccc_label)
}