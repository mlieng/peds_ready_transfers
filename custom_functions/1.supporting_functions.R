...
db_copy_and_subset = function(file, oshpd_folder,
                              ...
                              diagnostic=TRUE,
                              add_pdd_2017_cols=FALSE,
                              add_pdd_2011_source_cols=FALSE
){
  ...
  # add empty columns for non-2017_pd datasets
  if(add_pdd_2017_cols){
    suppress_out=dbExecute(con, "
                           ALTER TABLE temp_table
                           ADD column source_ns TEXT,
                           ADD column srcpo_ns TEXT,
                           ADD column srclicns_ns TEXT,
                           ADD column srcroute_ns TEXT,
                           ADD column admtype_ns TEXT
                           ")
  }

  # add empty columns in 2017_pd
  if(add_pdd_2011_source_cols){
    suppress_out=dbExecute(con, "
                           ALTER TABLE temp_table
                           ADD column source INT,
                           ADD column srcsite INT,
                           ADD column srclicns INT,
                           ADD column srcroute INT,
                           ADD column admtype INT
                           ")
  }
...
recode_add_PDD_subset <- function(){
  ...
  suppress_out = dbExecute(con, "
   ...
   source AS ip_source, srcsite AS ip_source_site, srclicns AS ip_source_license,
   srcroute AS ip_source_route, admtype AS ip_admission_type,
   source_ns AS ip_source_ns, srcpo_ns AS ip_source_ns_site, srclicns_ns AS ip_source_ns_license,
   srcroute_ns AS ip_source_ns_route, admtype_ns AS ip_admission_ns_type,
   ...
   ccs_odiag11 AS ccs_odx11, ccs_odiag12 AS ccs_odx12,
   ccs_odiag13 AS ccs_odx13, ccs_odiag14 AS ccs_odx14, ccs_odiag15 AS ccs_odx15,
   ccs_odiag16 AS ccs_odx16, ccs_odiag17 AS ccs_odx17, ccs_odiag18 AS ccs_odx18,
   ccs_odiag19 AS ccs_odx19, ccs_odiag20 AS ccs_odx20,
   ccs_odiag21 AS ccs_odx21, ccs_odiag22 AS ccs_odx22,
   ccs_odiag23 AS ccs_odx23, ccs_odiag24 AS ccs_odx24,
...
recode_add_EDD_subset <- function(){
  ...
  suppress_out=dbExecute(con, "
                         ...
                         ADD column ip_source_ns TEXT,
                         ADD column ip_source_ns_site TEXT,
                         ADD column ip_source_ns_license TEXT,
                         ADD column ip_source_ns_route TEXT,
                         ADD column ip_admission_ns_type TEXT,
                         ...
                         ADD column ip_mdc TEXT,
                         ADD column ip_msdrg TEXT,
  ...
  suppress_out = dbExecute(con, "
    INSERT INTO combined_peds
     ...
     los, los_adj, ip_charge,
     ip_source, ip_source_site, ip_source_license, ip_source_route,
     ip_admission_type,
     ip_source_ns, ip_source_ns_site, ip_source_ns_license, ip_source_ns_route,
     ip_admission_ns_type,
     ...
     dx_poa_prin,
     ccs_dx_prin, ccs_odx1, ccs_odx2, ccs_odx3, ccs_odx4, ccs_odx5, ccs_odx6, ccs_odx7, ccs_odx8, ccs_odx9, ccs_odx10,
     ccs_odx11, ccs_odx12, ccs_odx13, ccs_odx14, ccs_odx15, ccs_odx16, ccs_odx17, ccs_odx18, ccs_odx19, ccs_odx20,
     ccs_odx21, ccs_odx22, ccs_odx23, ccs_odx24,
