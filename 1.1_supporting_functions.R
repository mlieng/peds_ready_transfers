...
recode_add_PDD_subset <- function(){
  ...
  suppress_out = dbExecute(con, "
   ...
   diag_p AS dx_prin, odiag1 AS odx1, odiag2 AS odx2, odiag3 AS odx3, 
   odiag4 AS odx4, odiag5 AS odx5,  odiag6 AS odx6,  odiag7 AS odx7,
   odiag8 AS odx8,  odiag9 AS odx9,  odiag10 AS odx10,
